# Keepass_Sec
It's a password manager, designed to be used from the terminal. 💻
...
<img src="https://github.com/HackUnderway/keepass_sec/blob/main/demo.png" title="Keepass_Sec">

## Note
When you run it for the first time, you need to create your master key, which will be required each time you start the program. This enhances security and prevents unauthorized access to your password manager, **Keepass_Sec**.
...
# USAGE
```
git clone https://github.com/HackUnderway/keepass_sec.git
```
```
cd keepass_sec
```
```
python3 keepass_sec.py
```
# REQUIREMENTS
```
...
# LICENSE
- [x] Keepass_Sec is licensed. 
- [x] See [LICENSE](https://github.com/HackUnderway/keepass_sec#MIT-1-ov-file) for more information.
